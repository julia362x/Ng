...
wget -q https://downloads.rclone.org/v1.54.0/rclone-v1.54.0-linux-amd64.zip
unzip -q rclone-v1.54.0-linux-amd64.zip
export PATH=$PWD/rclone-v1.54.0-linux-amd64.zip:$PATH
